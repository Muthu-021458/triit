            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="text-gray-600 space-y-1">
                  ...
                  <p className="text-pink-600 font-semibold mt-2">Open Daily!</p>
                </div>
              </div>
            </div>
          </div>

          <div className="bg-gradient-to-br from-pink-200 to-orange-200 rounded-3xl p-8 shadow-lg flex items-center justify-center">
            <div className="text-center">
              <div className="text-8xl mb-4">🗺️</div>
              <p className="text-gray-700 font-semibold text-lg">Map Location</p>
              <p className="text-gray-600 mt-2">Find us easily on your favorite map app</p>
            </div>
          </div>
        </div>
      </div>
